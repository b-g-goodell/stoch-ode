...
The arithmetic term governing the rate appears multiple times in the ODE, but it is still only \emph{one} event.
...
Review content on ethics in mathematics, since this model relates to public health issues.
