\begin{modelingproject}[\label{sec:projects}The projects below pose open-ended investigations that start capstone or thesis work. Each names a modeling context and some entry points, and leaves the scope, depth of analysis, and choice of tools to the reader. The projects have no unique correct answers.]
...
\item %
The classical Lotka-Volterra\cite{lotka1925elements,volterra1926variazioni}\index{Lotka-Volterra equations}\index{predator-prey model|see{Lotka-Volterra equations}} predator-prey model with prey $H$ (hosts) and predators $P$ is as follows, where $\alpha, \beta, \delta, \gamma > 0$.
\begin{align*}
