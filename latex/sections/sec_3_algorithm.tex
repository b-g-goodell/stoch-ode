...
label={lst:dg-algorithm-python-template}]{\detokenize{../simulation_frameworks/framework_template.py}}
...
\input{sections/sec_3_1_alg_rescaling}
\input{sections/sec_3_2_alg_events}
\input{sections/sec_3_3_alg_wait_time}
\input{sections/sec_3_4_alg_pmf}
\input{sections/sec_4_alg_farming}
\input{sections/sec_5_alg_visualizing}
