...
label={lst:dg-algorithm-python-template}]{\detokenize{stoch-ode/latex/simulation_frameworks/framework_template.py}}
...
\lstinputlisting[float=htbp, language=Python, numbers=none, linerange={34-38}, caption={The generic \texttt{Python} waiting-time subroutine \RateToDeltaTime{}, paired with the pseudocode $\textsf{RateToDeltaTime}$ of Figure~\ref{fig:dg_subroutines_a}.}, label={lst:framework_rate_to_delta_time}]{stoch-ode/latex/tools/simcore.py}

\lstinputlisting[float=htbp, language=Python, numbers=none, linerange={7-31}, caption={The generic \texttt{Python} subroutines \RatesToPmf{} and \PmfToEventIndex{}, paired with the pseudocode of Figure~\ref{fig:dg_subroutines_b}.}, label={lst:framework_dg_core}]{stoch-ode/latex/tools/simcore.py}
...
\input{stoch-ode/latex/sections/sec_3_1_alg_rescaling}
\input{stoch-ode/latex/sections/sec_3_2_alg_events}
\input{stoch-ode/latex/sections/sec_3_3_alg_wait_time}
\input{stoch-ode/latex/sections/sec_3_4_alg_pmf}
\input{stoch-ode/latex/sections/sec_4_alg_farming}
\input{stoch-ode/latex/sections/sec_5_alg_visualizing}
