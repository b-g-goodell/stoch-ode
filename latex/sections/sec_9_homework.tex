...
\item Work through the following steps to prove that the only continuous real-valued random variable $T$ which is memoryless\index{memoryless property} is the exponential random variable.\label{ex:hw_memoryless_rigorous}%
\begin{enumerate}[(a)]
