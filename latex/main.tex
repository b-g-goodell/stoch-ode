%\input{stoch-ode/latex/sections/preamble}
%\input{stoch-ode/latex/python_macros}
%\input{includes/stoch-ode}
%\begin{document}

\input{stoch-ode/latex/sections/front_matter}

\input{stoch-ode/latex/sections/sec_1_introduction}

\input{stoch-ode/latex/sections/sec_2_resolving}

\input{stoch-ode/latex/sections/sec_3_algorithm}

\input{stoch-ode/latex/sections/sec_6_parameter_sweep}

\input{stoch-ode/latex/sections/sec_7_sensitivity}

\input{stoch-ode/latex/sections/sec_8_summary}

\input{stoch-ode/latex/sections/sec_9_homework}

\input{stoch-ode/latex/sections/sec_10_projects}

\input{stoch-ode/latex/sections/sec_11_glossary}
...
\end{thebibliography}
%\bibliography{stoch-ode/latex/bibliography}
